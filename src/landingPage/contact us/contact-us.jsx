...
<p className='p1'>Start your new journey with us and join our community</p>
<h2>Get in touch <br />
We want to share our location <br />
to find us easily.</h2>

<div className="adr">
<SlLocationPin className='location'  />
<p><b>Office Address </b> <br />74A High Road, Wanstead, London, E11 7RJ</p>
...
<div className="login">
       ...
       <h1>Enter your email</h1>
        <div className="gmail">
         <hr/><img  src='/gmail.png' alt='gmail' /><hr/>
        </div>
        <div className="fullname">
               ...
               <div className="surname">
                <label htmlFor="surname">surname</label><br />
                 <input className='inputt' id='surname' placeholder='Enter your surname'/>
               </div>
