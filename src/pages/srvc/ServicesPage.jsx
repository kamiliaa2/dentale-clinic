...
const ServicesPage = () => {
  return (
    ...
    <div className="infos-ktb3">
      ...
      <h1>Elevating Smiles, Tailored 
           Services: Your Path To Comprehensive 
           Dental well-being</h1>
     </div>
     <div className="icons-ktb3">
      ...
      <p className="discreption-ktb3">Dui Tristique pretium tempor odio ante commodo</p>
      </div>
      </div>
      <div className="icon-ktb3">
     ...
     <div className="services-image-ktb3">
        <img src="/services-pctrs/wepik-export-20240223153106FhKk 1.png" alt="Services" />
      </div>
    </div>
    </div>
  );
